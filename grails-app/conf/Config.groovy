...
grails.plugins.springsecurity.userLookup.userDomainClassName = 'co.freeside.User'
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'co.freeside.UserRole'
grails.plugins.springsecurity.authority.className = 'co.freeside.Role'
grails.plugins.springsecurity.requestMap.className = 'co.freeside.RequestMap'
